...
def get_pose3D(video_path, output_dir):
    ...
    # Load the 2D keypoints generated from the video.
    ...
    # Combine the 2D and 3D images into the result video.
    image_dir = 'results/' 
    ...
    for i in tqdm(range(len(image_2d_dir))):
        ...
        # Crop both images for side-by-side display.
